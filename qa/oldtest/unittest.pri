...
run.commands = DISABLE_BREAKPAD=true YACHATDATADIR=~/.yachat-psi-test ./$$EXEC_TARGET
...
unix {
	...
	gdb.commands += DISABLE_BREAKPAD=true YACHATDATADIR=~/.yachat-psi-test gdb ./$$EXEC_TARGET
	mac {
		gdb.commands += ; \
			for f in $$QT_FRAMEWORKS; do \
