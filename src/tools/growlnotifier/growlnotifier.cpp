...
public: 
	GrowlNotifierSignaler(QObject* parent)
		: QObject(parent)
	{}
 ...
 *	register with growl.
 */
GrowlNotifier::GrowlNotifier(QObject* parent, const QStringList& notifications, const QStringList& default_notifications, const QString& app)
	: QObject(parent)
{
	// Initialize signaler
	signaler_ = new GrowlNotifierSignaler(this);
