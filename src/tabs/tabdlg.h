...
typedef YaTabWidget TabWidgetClass;
#else
class PsiTabWidget;
typedef PsiTabWidget TabWidgetClass;
...
public:
	...
	virtual void tabWidgetCreated(QWidget *widget, TabWidgetClass *tabWidget);
...
private:
	...
	void updateCaption();
	void closeTabs(QCloseEvent* closeEvent = 0);
